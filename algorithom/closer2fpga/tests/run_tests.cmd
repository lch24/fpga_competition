...
pushd "%~dp0build"
cl /nologo /std:c++20 /EHsc /O2 /MD /utf-8 /W3 /I"%OPENCV_ROOT%\include\opencv4" "%~dp0corner_regression.cpp" "%~dp0..\closer2fpga\algo\chessboard.cpp" "%~dp0..\closer2fpga\algo\shi_tomasi.cpp" "%~dp0..\closer2fpga\algo\subpixel.cpp" /Fe:corner_regression.exe /link /LIBPATH:"%OPENCV_ROOT%\lib" opencv_core4.lib opencv_imgproc4.lib opencv_imgcodecs4.lib opencv_calib3d4.lib
if errorlevel 1 exit /b 2
