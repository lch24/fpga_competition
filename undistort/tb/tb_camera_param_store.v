...
module tb_camera_param_store;
    ...
    reg                 s_param_valid;
    wire                s_param_ready;
    reg signed [31:0]   s_fx;
    reg signed [31:0]   s_fy;
    reg signed [31:0]   s_cx;
    reg signed [31:0]   s_cy;
    reg signed [31:0]   s_k1;
    reg signed [31:0]   s_k2;
    reg signed [31:0]   s_p1;
    reg signed [31:0]   s_p2;
    reg signed [31:0]   s_k3;
    reg        [15:0]   s_calib_width;
    reg        [15:0]   s_calib_height;
    reg        [15:0]   s_calib_id;
    reg        [31:0]   s_rms_error;
    reg                 map_busy;

    wire                active_valid;
    wire                active_update;
    wire signed [31:0]  active_fx;
    wire signed [31:0]  active_fy;
    wire signed [31:0]  active_cx;
    wire signed [31:0]  active_cy;
    wire signed [31:0]  active_k1;
    wire signed [31:0]  active_k2;
    wire signed [31:0]  active_p1;
    wire signed [31:0]  active_p2;
    wire signed [31:0]  active_k3;
    wire        [15:0]  active_calib_width;
    wire        [15:0]  active_calib_height;
    wire        [15:0]  active_calib_id;
    wire        [31:0]  active_rms_error;
    wire                shadow_pending;
    ...
    initial begin
        ...
        if (active_calib_id != 16'd1 || active_calib_width != 16'd1280 ||
            active_calib_height != 16'd720)
            fail("first metadata set was not committed atomically");
        if (active_fx != 32'sd90139792 || active_k1 != -32'sd68204287)
        ...
        wait (active_update);
        #1;
        if (active_calib_id != 16'd2 || active_fx != 32'sd65536000)
